...
<body>
    ...
    <form action="validatoin-form/auth.php" method="post">
        ...
        <div class="form-group">
            <button class="btn btn-primary btn-block create-account" type="submit"><font face="Nunito">Увійти</font></button>
        </div>
    </form>
</div>
	...
	<form action="validatoin-form/check.php" method="post">
		...
		<div class="form-group">
				<button class="btn btn-primary btn-block create-account" type="submit"><font face="Nunito">Зареєструватися</font></button>
		</div>
</form>
</div>
<?php else:
	...
	?>
	<a href="validatoin-form/exit.php">Вийти</a>
<?php endif;?>
